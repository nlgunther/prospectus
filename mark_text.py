...
rexar = 'Allocation of Senior Reduction Amount and Subordinate Reduction Amount;Allocation of Calculated Tranche Write.*down Amounts;Allocation of Calculated Tranche Write.*up Amounts'.split(';')
rexs = '|'.join(rexar)
